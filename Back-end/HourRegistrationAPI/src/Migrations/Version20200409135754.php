 ...
 */
final class Version20200409135754 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hour ADD user_id VARCHAR(29) NOT NULL, CHANGE hours hours INT DEFAULT NULL');
